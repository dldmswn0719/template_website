...
function Example() {
    ...
    // 이미지가 로딩이 성공 되었다면 > 성공판정
    // 이미지가 로딩이 실패 되었다면 > 실패판정
    // 로딩 실패시 > 에러가 발생 > error
    ...
    //앞은 성공이고 try,catch문은 실패할수있다
    // fetch - 함수 사용시 Promise 를 반환 > then / catch 를 사용할수 있다.
    ...
    return (
        <div>
            {/* <img id='img' src="https://via.placeholder.com/500" alt="500x500" /> */}
            {
